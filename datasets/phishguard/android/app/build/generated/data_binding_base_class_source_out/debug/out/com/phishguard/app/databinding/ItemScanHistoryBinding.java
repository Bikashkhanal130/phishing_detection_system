...
public final class ItemScanHistoryBinding implements ViewBinding {
  ...
  private ItemScanHistoryBinding(@NonNull CardView rootView, @NonNull TextView tvBadge,
      @NonNull TextView tvConfidence, @NonNull TextView tvDate, @NonNull TextView tvUrl) {
  ...
  public static ItemScanHistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemScanHistoryBinding((CardView) rootView, tvBadge, tvConfidence, tvDate, tvUrl);
    }
